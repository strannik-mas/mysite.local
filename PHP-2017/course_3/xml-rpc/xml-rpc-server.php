...
xmlrpc_server_register_method($rpcServer, "getNewsById", [new NewsService, "xmlRpcGetNewsById"]);
header('Content-Type: text/xml;charset=utf-8');
print xmlrpc_server_call_method($rpcServer, $request, null);
/*
$a = new NewsService();
var_dump($a->getNewsById(1));
 * 
 */
?>