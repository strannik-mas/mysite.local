...
class NewsService extends NewsDB {
    ...
    function getNewsById($id) {
        try {
            ...
            return base64_encode(serialize($this->dbToArr($result)));
        } catch (Exception $e) {
...
/* $o = new NewsService();
echo '<p>'.$o->getNewsCountByCat(1).'</p>';
* 
*/ 
ini_set("soap.wsdl_cache_enabled", "0");
$server = new SoapServer("http://mysite.local/PHP-2017/course_3/newsoap/news2.wsdl");
